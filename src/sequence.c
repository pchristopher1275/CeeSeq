...
void Sequence_start(Sequence *self, Ticks a1, Ticks a2, TimedAr *a3, Error *err)
{
    switch(self->itype) {
       default:
            Error_format(err, "Failed to resolve interface call in <EXPAND_FAIL>_start: found type %s", Interface_toString(self->itype));
    }
    return;
}
...
void Sequence_drive(Sequence *self, Ticks a1, TimedAr *a2, Error *err)
{
    switch(self->itype) {
       default:
            Error_format(err, "Failed to resolve interface call in <EXPAND_FAIL>_drive: found type %s", Interface_toString(self->itype));
    }
    return;
}
...
void Sequence_startRecord(Sequence *self, Error *err)
{
    switch(self->itype) {
       default:
            Error_format(err, "Failed to resolve interface call in <EXPAND_FAIL>_startRecord: found type %s", Interface_toString(self->itype));
    }
    return;
}
...
Sequence *Sequence_recordingSeq(Sequence *self, Ticks a1, Error *err)
{
    switch(self->itype) {
        default:
            Error_format(err, "Failed to resolve interface call in <EXPAND_FAIL>_recordingSeq: found type %s", Interface_toString(self->itype));
    }
    return NULL;
}
...
void Sequence_stop(Sequence *self, Error *err)
{
    switch(self->itype) {
       default:
            Error_format(err, "Failed to resolve interface call in <EXPAND_FAIL>_stop: found type %s", Interface_toString(self->itype));
    }
    return;
}
